...
<div id="apps-root" style="display:none;"><#-- NOTE: webrootVue component attaches here, uses this and below for template -->
    ...
    <input type="hidden" id="confBasePath" value="${ec.web.servletContext.contextPath}/vendorinternal">
    <input type="hidden" id="confLinkBasePath" value="${ec.web.servletContext.contextPath}/vendor">
    ...
    <q-layout view="hHh LpR fFf">
        <q-header class="${headerClass}" id="top">
            ...
            <#if headerLogoList?has_content>
                <m-link href="/vendor"><div class="q-mx-md q-mt-sm">
