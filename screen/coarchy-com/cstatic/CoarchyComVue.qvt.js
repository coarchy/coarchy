...
new Vue({
    ...
    //         console.info(this.currentLinkUrl === url && url !== this.linkBasePath)
    ...
    //     },
    //     currentLinkUrl: function() { var search = this.currentSearch; console.log('currentLinkUrl'); console.log(this); return this.currentLinkPath + (search.length > 0 ? '?' + search : ''); },
    // },
    // created: function() {
